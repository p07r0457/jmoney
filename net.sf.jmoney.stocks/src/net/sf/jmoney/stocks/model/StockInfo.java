...
public class StockInfo implements IPropertySetInfo {
	...
	private static ExtendablePropertySet<Stock> propertySet = PropertySet.addDerivedFinalPropertySet(Stock.class, "Stock", CommodityInfo.getPropertySet(), new IExtendableObjectConstructors<Stock>() {
