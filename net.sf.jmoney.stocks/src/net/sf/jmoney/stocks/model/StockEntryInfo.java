...
public class StockEntryInfo implements IPropertySetInfo {
	...
	private static ExtensionPropertySet<StockEntry> propertySet = PropertySet.addExtensionPropertySet(StockEntry.class, EntryInfo.getPropertySet(), new IExtensionObjectConstructors<StockEntry>() {

		public StockEntry construct(ExtendableObject extendedObject) {
