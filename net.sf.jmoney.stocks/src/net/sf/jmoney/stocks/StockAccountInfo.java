...
public class StockAccountInfo implements IPropertySetInfo {
	...
	private static ScalarPropertyAccessor<String> brokerageFirmAccessor = null;
	private static ScalarPropertyAccessor<String> accountNumberAccessor = null;
	private static ScalarPropertyAccessor<String> tax1NameAccessor = null;
	private static ScalarPropertyAccessor<String> tax2NameAccessor = null;
	private static ReferencePropertyAccessor<IncomeExpenseAccount> dividendAccountAccessor = null;
	private static ReferencePropertyAccessor<IncomeExpenseAccount> withholdingTaxAccountAccessor = null;
	private static ReferencePropertyAccessor<IncomeExpenseAccount> commissionAccountAccessor = null;
	private static ReferencePropertyAccessor<IncomeExpenseAccount> tax1AccountAccessor = null;
	private static ReferencePropertyAccessor<IncomeExpenseAccount> tax2AccountAccessor = null;
	private static ScalarPropertyAccessor<RatesTable> buyCommissionRatesAccessor = null;
	private static ScalarPropertyAccessor<RatesTable> sellCommissionRatesAccessor = null;
	private static ScalarPropertyAccessor<RatesTable> tax1RatesAccessor = null;
	private static ScalarPropertyAccessor<RatesTable> tax2RatesAccessor = null;
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<String> getBrokerageFirmAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<String> getTax1NameAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<String> getTax2NameAccessor() {
	 ...
	 * @return
	 */
	public static ReferencePropertyAccessor<IncomeExpenseAccount> getDividendAccountAccessor() {
	 ...
	 * @return
	 */
	public static ReferencePropertyAccessor<IncomeExpenseAccount> getCommissionAccountAccessor() {
	 ...
	 * @return
	 */
	public static ReferencePropertyAccessor<IncomeExpenseAccount> getTax1AccountAccessor() {
	 ...
	 * @return
	 */
	public static ReferencePropertyAccessor<IncomeExpenseAccount> getTax2AccountAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<RatesTable> getBuyCommissionRatesAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<RatesTable> getSellCommissionRatesAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<RatesTable> getTax1RatesAccessor() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<RatesTable> getTax2RatesAccessor() {
