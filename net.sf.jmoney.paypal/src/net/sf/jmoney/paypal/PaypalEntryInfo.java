...
public class PaypalEntryInfo implements IPropertySetInfo {
	...
	private static ExtensionPropertySet<PaypalEntry> propertySet = PropertySet.addExtensionPropertySet(PaypalEntry.class, EntryInfo.getPropertySet(), new IExtensionObjectConstructors<PaypalEntry>() {

		public PaypalEntry construct(ExtendableObject extendedObject) {
			return new PaypalEntry(extendedObject);
		}

		public PaypalEntry construct(ExtendableObject extendedObject, IValues values) {
	 ...
	 * @return
	 */
	public static ExtensionPropertySet<PaypalEntry> getPropertySet() {
		return propertySet;
	}

	public static ScalarPropertyAccessor<String> getMerchantEmailAccessor() {
		return merchantEmailAccessor;
	}

	public static ScalarPropertyAccessor<URL> getItemUrlAccessor() {
