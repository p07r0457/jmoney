...
public class AmeritradeImportWizard extends CsvImportWizard {
	...
	static private Pattern patternAdr;
	static private Pattern patternForeignTax;
	...
	private MandatoryExchange mandatoryExchange;
	...
	public void importLine(String[] line) throws ImportException {
        ...
        if (mandatoryExchange != null
        	...
        	mandatoryExchange.createTransaction(session, account);
        	mandatoryExchange = null;
        }
