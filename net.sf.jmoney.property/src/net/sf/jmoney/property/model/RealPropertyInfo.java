...
public class RealPropertyInfo implements IPropertySetInfo {
	...
	private static ExtendablePropertySet<RealProperty> propertySet = PropertySet.addDerivedFinalPropertySet(RealProperty.class, "Real Property", CommodityInfo.getPropertySet(), new IExtendableObjectConstructors<RealProperty>() {
		...
		public RealProperty construct(IObjectKey objectKey,	ListKey parentKey, IValues values) {
	...
	private static ReferencePropertyAccessor<IncomeExpenseAccount> rentalIncomeAccountAccessor = null;
	 ...
	 * @return
	 */
	public static ReferencePropertyAccessor<IncomeExpenseAccount> getRentalIncomeAccountAccessor() {
