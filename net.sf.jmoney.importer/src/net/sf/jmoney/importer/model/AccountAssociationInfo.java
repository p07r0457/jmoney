...
public class AccountAssociationInfo implements IPropertySetInfo {
	...
	private static ExtendablePropertySet<AccountAssociation> propertySet = PropertySet.addBaseFinalPropertySet(AccountAssociation.class, "Account Association", new IExtendableObjectConstructors<AccountAssociation>() {
		...
		public AccountAssociation construct(IObjectKey objectKey,
				ListKey<? super AccountAssociation> parentKey, IValues values) {
	...
	private static ScalarPropertyAccessor<String> idAccessor = null;
	private static ReferencePropertyAccessor<Account> accountAccessor = null;

	public PropertySet<AccountAssociation> registerProperties() {
	 ...
	 * @return
	 */
	public static ScalarPropertyAccessor<String> getIdAccessor() {
		return idAccessor;
	}	
