...
public class IncomeExpensePage implements IBookkeepingPageListener {
	...
	public BookkeepingPage[] createPages(Object selectedObject, Session session, Composite parent) {
			// Set up the Swing composite as the only control in the parent.
			...
			final IncomeExpenseReportPanel reportPanel = new  IncomeExpenseReportPanel();
			...
			{ new BookkeepingPage(swingComposite, "Income & Expense Report") };
	}
}
