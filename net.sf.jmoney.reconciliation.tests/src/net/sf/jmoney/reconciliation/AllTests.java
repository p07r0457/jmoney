 ...
 * 
 * org.example.foo package structure (either directly, or in any subpackage). By
 * default this will include all non-abstract classes named
 * 
 * XxxTest , excluding XxxPlatformTest if running outside of the platform.
 */
public class AllTests {
	/**
	 * Detects classes from the bundle PLUGIN_NAME's entries. Uses
	 * 
	 * bundle.findEntries to obtain a list of classes that live in the specified
	 ...
	 * @param inContainer
	 *            true if we want to include the inContainer tests
