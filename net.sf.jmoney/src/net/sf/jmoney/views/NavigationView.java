	...
	private void makeActions() {
		newAccountAction = new Action() {
			public void run() {
		        ...
		        MutableCapitalAccount mutableAccount = session.createNewCapitalAccount();
		        mutableAccount.setName(JMoneyPlugin.getResourceString("Account.newAccount"));
		        CapitalAccount account = mutableAccount.commit();
